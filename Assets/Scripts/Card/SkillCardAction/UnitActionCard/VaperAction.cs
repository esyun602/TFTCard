...
public class VaperAction : UnitSkillCardActionBase
{
    private float timePassed;
    private bool canceled;

    public VaperAction(VaperActionSpec spec) : base(spec)
    {
    }
    ...
    protected override void OnUpdate(float dt, out bool routineDone)
    {
        ...
        if (timePassed > 0f)
        {
            ...
            {
                airShip.UnitCardBattleStat.AddValueByValueType(UnitValueType.Attack, BattleStat.GetValueByValueType(UnitValueType.Attack));
            }
